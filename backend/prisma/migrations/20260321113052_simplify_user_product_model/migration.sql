/*
  ...
  - You are about to drop the column `seller_enabled` on the `users` table. All the data in the column will be lost.
  - You are about to drop the column `store_bio` on the `users` table. All the data in the column will be lost.
  - You are about to drop the column `store_logo_url` on the `users` table. All the data in the column will be lost.
  - You are about to drop the column `store_name` on the `users` table. All the data in the column will be lost.
  - You are about to drop the column `store_slug` on the `users` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "users_store_slug_key";

-- AlterTable
ALTER TABLE "users" DROP COLUMN "seller_enabled",
DROP COLUMN "store_bio",
DROP COLUMN "store_logo_url",
